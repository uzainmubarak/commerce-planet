...
CREATE TABLE "VariantValues" (
    ...
    CONSTRAINT "VariantValues_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "VariantValues_variantId_idx" ON "VariantValues"("variantId");
...
-- AddForeignKey
ALTER TABLE "VariantValues" ADD CONSTRAINT "VariantValues_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "Variant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
